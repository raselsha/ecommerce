...
<table width="100%">
	<tr>
		<td colspan="11"><a href="add_product.php">Add product</a></td>
	</tr>
	<tr bgcolor="#eee">
		<th>Sl</th>
		<th>Name </th>
	...
	<?php
		...
		if (isset($_GET['search']) and $_GET['search'] != '') {
			...
			if (isset($_GET['page']) and $_GET['page'] != '') {
				...
				$result = $prdct->all_products_search($search,$limit,$offset);
			}
			else{
				$result = $prdct->all_products_search($search,$limit,$offset);
			}
			...
			if ($result->num_rows!=0) {
				...
				echo '<td align="center" width="180">
						...
						<a class="yellow_bg white padding" href="edit_product.php?id='.base64_encode($row['id']).'">Edit</a> | 
