<?php
	...
	if (isset($_POST['save'])) {
		...
		if ($er==0) {
			...
			$message = $med->add_medicine($_POST);
			$name = '';
			$name_en = '';
			$name_grp =''; 
			$used = '';
	...
	<form method="post" enctype="multipart/form-data">
		<tr valign="top">
			<td width="40%">
				...
				<p><input type="text" name="name_en" value="<?= $name_en; ?>"><?= $er_name_en; ?></p>
				...
				<p><input type="text" name="name_grp" value="<?= $name_grp; ?>"><?= $er_name_grp; ?></p>

				<p><label>Instruction (বাংলা)</label></p>
				<p><textarea name="instruction" rows="5" cols="30"><?= $instruction; ?></textarea><?= $er_instruction; ?></p>

				<p><label>Prescribe (বাংলা)</label></p>
				<p><textarea name="prescribe" rows="5" cols="30"><?= $prescribe; ?></textarea><?= $er_prescribe; ?></p>
			...
			<td>
				...
				<p><input type="text" name="used" value="<?= $used; ?>"><?= $er_used; ?></p>
				...
				<p><input type="text" name="price_en" value="<?= $price_en; ?>"><?= $er_price_en; ?></p>
